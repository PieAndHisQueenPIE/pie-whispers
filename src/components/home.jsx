...
const getWallpaperColor = (index) => {
  const colors = {
    1: "rgba(255, 255, 224, 0.6)",
    2: "rgba(255, 255, 224, 0.6)",
    3: "rgba(255, 255, 224, 0.6)",
    4: "rgba(255, 255, 224, 0.6)",
    5: "rgba(43, 43, 43, 0.6)",
    6: "rgba(213, 204, 204, 0.6)",
    7: "rgba(176, 224, 230, 0.6)",
    8: "rgba(240, 128, 128, 0.6)",
    9: "rgba(221, 160, 221, 0.6)",
  };
